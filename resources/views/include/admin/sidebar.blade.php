<div class="sidenav">
    ...
    <li class="nav-item">
          <a class="nav-link hover {{request()->is('dashboard') ? 'active' : ''}}" href="{{ route('dashboard') }}"> <i class="fas fa-tachometer-alt" aria-hidden="true"></i> &nbsp; Dashboard</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link hover" href="{{route('genre.index')}}"><i class="fas fa-tv"></i> &nbsp; Genre</a>
        </li>
        <li class="nav-item">
